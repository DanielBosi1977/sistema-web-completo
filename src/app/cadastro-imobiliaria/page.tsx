    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
      <Card className="w-full max-w-lg">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold">Cadastro de Imobiliária</CardTitle>
          <CardDescription>
            {formStep === 1 
              ? 'Preencha os dados da sua imobiliária para criar uma conta' 
              : 'Informe o endereço da imobiliária'}
          </CardDescription>
        </CardHeader>
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Sua imobiliária foi cadastrada na plataforma S8 Garante. 
              Anote sua senha provisória para realizar o primeiro acesso.
            </DialogDescription>
          </DialogHeader>
          <div className="p-4 bg-gray-100 rounded-md text-center">
            <p className="font-medium">Sua senha provisória é:</p>
            <p className="text-xl font-bold mt-2">{senhaProvisoria}</p>
          </div>
          <p className="text-sm text-gray-500">
            No primeiro acesso, você será solicitado a alterar esta senha.
          </p>
          <DialogFooter>
